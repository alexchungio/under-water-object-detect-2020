...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'train/annotation/voc_all.json',
...
log_level = 'INFO'
work_dir = './outputs/htc_rcnn_x_101_64x4d_fpn_1x'
load_from = data_root + 'htc_x101_64x4d_fpn_16x1_20e_coco_20200318-b181fd7a.pth'
resume_from = None
workflow = [('train', 1)]
